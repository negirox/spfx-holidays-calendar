...
export default function HolidaysList(props: IHolidaysListProps) {
				...
				renderCell: (item) => {
					return (
						<TableCell>
							...
							<TableCellActions>
								<Button style={{display:'none'}} icon={<CalendarAdd20Regular />} appearance="subtle" onClick={() => props.onCalendarAddClick(item.Id)} />
							</TableCellActions>
						</TableCell>
					);
				},
	...
	return (
		<>
			<Title2 align="center" style={{ fontFamily: "inherit", fontSize:"large" }}>
				{props.title}
			</Title2>
